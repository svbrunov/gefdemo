...
import org.tigris.gefdemo.bert.persistence.SaveAction;
...
public class BertDemo {
    ...
    private static BertDemo instance;

    public BertDemo getInstance() {
        return instance;
    }
...
//        DiagramPanel sequenceDiagramPanel2 = null;
        try {
            classDiagramPanel1 = new DiagramPanel(

...
implements IStatusBar, Cloneable, ModeChangeListener {
  ...
  protected PaletteLAN _toolbar2 = new PaletteLAN();

  /** The Propert Sheet tabbed pane */
  public JTabbedPane _tabPane = new JTabbedPane(JTabbedPane.TOP);
  ...
  protected JPanel _bottomPanel = new JPanel(new BorderLayout());
